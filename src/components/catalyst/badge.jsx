...
const colors = {
  ...
  mauve:
    'bg-mauve-500/15 text-mauve-700 group-data-hover:bg-mauve-500/25 dark:bg-mauve-500/10 dark:text-mauve-400 dark:group-data-hover:bg-mauve-500/20',
  mist: 'bg-mist-500/15 text-mist-700 group-data-hover:bg-mist-500/25 dark:bg-mist-500/10 dark:text-mist-400 dark:group-data-hover:bg-mist-500/20',
}
...
export const BadgeButton = forwardRef(function BadgeButton(
  ...
  let classes = clsx(
    className,
    'group relative inline-flex rounded-md focus:not-data-focus:outline-hidden data-focus:outline-2 data-focus:outline-offset-2 data-focus:outline-mauve-500'
  )
